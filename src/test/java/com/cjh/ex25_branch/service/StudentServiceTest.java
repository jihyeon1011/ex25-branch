package com.cjh.ex25_branch.service;
...
import com.cjh.ex25_branch.domain.StudentTest;
import com.cjh.ex25_branch.mapper.StudentMapperTest;
...
//	then
		...
		assertEquals("이영희", students.get(1).getName());
	}
